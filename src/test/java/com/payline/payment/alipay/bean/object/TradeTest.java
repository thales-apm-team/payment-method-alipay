...
class TradeTest {
    ...
    @Test
    void setGmt_payment() {
        String gmtPayment = "14:15:16";
        trade.setGmt_payment(gmtPayment);
        Assertions.assertEquals(gmtPayment, trade.getGmt_payment());
    }
